...
router.get("/signup", checkSession.checkUserBlocked, userRender.signup);
router.get(
  "/checkout",
...
router.get("/login/forgotPassword", userRender.forgotPassword);

router.get("/login/resetPassword", userRender.resetPassword);

router.get("/products/details/:id", userRender.productDetails);
router.get(
  "/orders",
  checkSession.sessionExists,
  checkSession.checkUserBlocked,
...
router.post("/login", validation.checkUserExists, userController.userLogin);
router.post("/logout", checkSession.sessionExists, userController.userLogout);
...
router.post("/login/resetPassword", userController.resetPassword);

router.post("/product/addToCart", userController.addToCart);

router.post("/cart/product/remove", userController.removeFromCart);

router.post("/wishlist/product/addtowishlist", userController.addToWishlist);

router.post("/wishlist/product/remove", userController.removeFromWishlist);
...
router.post("/address/update/:addressId", userController.updateAddress);
